...
namespace IT_Lab3.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Doctor doctor = db.Doctors.Include(d => d.Hospital)
                .Include(d => d.Patients).FirstOrDefault(d => d.Id == id);
            if (doctor == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult InsertNewPatient(int id) // id na Doctor na koj ke se setira Patient
        {
        ...
        public ActionResult InsertPatientDoctor(PatientDoctor model)
        {
            ...
            //var doctor = db.Doctors.Where(z => z.Id == model.DoctorId).FirstOrDefault(); // Alternativna opcija
            doctor.Patients.Add(patient);
            db.SaveChanges();
            return Redirect("Details/" + model.DoctorId);
        }
